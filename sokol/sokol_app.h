...
SOKOL_APP_API_DECL double sapp_frame_duration_last(void);
...
_SOKOL_PRIVATE double _sapp_timing_get_last(_sapp_timing_t* t) {
    return t->last_dur;
}
...
SOKOL_API_IMPL double sapp_frame_duration_last(void) {
    return _sapp_timing_get_last(&_sapp.timing);
}
